...
import { hasLastRenderPayload, requeueLastRender } from '../../features/workflow/utils/globalRender';
        ...
        <div className="brand-row">
          ...
          {showRender ? (
            ...
            >
              <span className="inline-flex items-center justify-center">
                {renderActive ? <span className="loading-spinner" aria-hidden="true" /> : <IconRender size={16} />}
              </span>
              <span>{renderActive ? 'Rendering…' : 'Render'}</span>
            </Button>
          ) : null}
          ...
          {showDesktopLogout ? (
            ...
            >
              ...
              <span>Logout</span>
              {user ? <span className="text-xs text-[#9DA3FFB3]">@{user}</span> : null}
            </Button>
          ) : null}
